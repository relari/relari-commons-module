...
public class Regex {
    ...
    public static final String REGEXP_DOCUMENT_TYPE = "^(DNI|PASAPORTE|RUC|PARTIDA_DE_NACIMIENTO|CARNET_DE_EXTRANJERIA|OTROS)$";
    public static final String REGEXP_DOCUMENT_NUMBER = "^[a-zA-Z0-9]+$";
    ...
    public static final String REGEXP_DATE = "^\\d{2}/\\d{2}/\\d{4}$";
